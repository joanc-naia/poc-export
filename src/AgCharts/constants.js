...
export const borderLeftThin = {left: {style:'thin'}};
export const borderRight = {right: {style: 'medium'}};
export const borderRightThin = {right: {style: 'thin'}};
...
const fontBoldUnderline = {bold: true, underline: true}
...
export const box = {value: 'o', font: {name: 'Wingdings'}};
export const boxChecked = {value: 'þ', font: {name: 'Wingdings'}};
export const boxShaded = {value: 'n', font: {name: 'Wingdings'}};
